...
public class SentimentController {
    ...
    public SentimentController(SentimentRecordRepository repo, SentimentService sentimentService, AnalizarArchivoService archivoService) {
        this.repo = repo;
    ...
    @PostMapping("/analizar-archivo")
        public ResponseEntity<List<SentimentResponse>> analizarCSV(
            ...
            List<String> comentarios = archivoService.extraerComentariosDeCSV(file, columnName);
