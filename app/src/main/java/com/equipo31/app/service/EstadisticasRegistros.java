...
public class EstadisticasRegistros {
    ...
    //Servicio que se encarga de imprimir en consola primero los datos que se han insertado en la base de datos H2
    public void imprimirRegistrosEnConsola(List<SentimentRecord> registros) {
        ...
        if (registros == null || registros.isEmpty()) {
            ...
            log.info("-----------------------------------------------------------------------------------");
            log.info(String.format("%-5s | %-15s | %-12s | %-8s | %-20s", "ID", "FECHA", "SENTIMIENTO", "PROB", "TEXTO"));
            log.info("-----------------------------------------------------------------------------------");
